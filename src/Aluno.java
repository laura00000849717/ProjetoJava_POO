...
public class Aluno extends Usuario {
    ...
    private Aluno(String nome, String matricula) {
        this.nome = nome;
        this.matricula = matricula;
    }

    public static Aluno iniciarSessao() {
        Aluno usuarioInstance;
    ...
    public static Aluno criarUsuario() {
    ...
    public static Aluno logarUsuario() {
